...
export default function EditarCantidadModal({ visible, onClose, producto, onGuardar }) {
    ...
    const excedeStock = cantidadNum > producto.stock;
                        ...
                        <View style={styles.modalContainer}>
                            ...
                            <View style={styles.content}>
                                ...
                                <View style={styles.stockInfo}>
                                    <Ionicons
                                        name={excedeStock ? "alert-circle" : "information-circle"}
                                        size={16}
                                        color={excedeStock ? "#FF6B6B" : "#7F8C8D"}
                                    />
                                    <Text style={[styles.stockText, excedeStock && styles.stockTextError]}>
                                ...
                                <View style={styles.buttonContainer}>
                                    ...
                                    <TouchableOpacity
                                        style={[styles.saveButton, excedeStock && styles.saveButtonDisabled]}
